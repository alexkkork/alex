...
max_give = int(config.get("CREDITS", "max_give", fallback="0"))
max_deduct = int(config.get("CREDITS", "max_deduct", fallback="0"))
master = int(config.get("GENERAL", "master_duck", fallback="0"))
guild_id = [int(config.get("GENERAL", "allowed_guild", fallback="0"))]
